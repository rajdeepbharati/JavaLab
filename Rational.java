public class Rational implements Comparable<Rational> {
    ...
    public static void main(String[] args) {
        Rational x, y, z, a, b, c;

        // 1/2 + 1/3 = 5/6
        x = new Rational(1, 2);
        y = new Rational(0, 1);
        z = new Rational(5, 10);
        a = new Rational(14, 20);
        b = new Rational(7, 10);
        c = new Rational(100, 50);
        ...
        System.out.println(x.toString() + " + " + b.toString() + " = " + x.plus(b));
        System.out.println(c.toString() + " - " + z.toString() + " = " +c.minus(z));
    }
}
